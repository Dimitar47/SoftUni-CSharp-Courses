    ...
    public class StartUp
    {
        public static void Main()
        {
            ...
            File.WriteAllText(@"D:\Users\admin\Desktop\C# DB_SoftUni\Entity Framework Core - June 2024\"
                 + @"15. Exercise - JSON Processing\16. Export Local Suppliers\Datasets\local-suppliers.json",
                            result);
        }
        ...
        public static string GetLocalSuppliers(CarDealerContext context)
        {
            ...
            string sth = JsonConvert.SerializeObject(suppliers, Formatting.Indented);
